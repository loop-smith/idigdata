    ...
    <PresenceShell>
      ...
      <section className="p-section" style={{ background: "#F3ECE0" }}>
        <div className="page-well">
          ...
          <p className="p-prose">
            Three systems. A proven jump start from day one. You keep the
            engine.
          </p>
          <div className="build-stack">
            ...
            <article className="build-row">
              ...
              <div className="build-copy">
                ...
                <p className="mt-1 font-vollkorn text-[16px] font-bold text-navy/70">
                  The Builder Harness
                </p>
                <p className="mt-3 text-[17px] leading-[1.65]">
                  You command. The crew builds. Nothing ships until the work
                  holds.
                </p>
              </div>
            </article>
            ...
            <article className="build-row">
              ...
              <div className="build-copy">
                ...
                <p className="mt-3 text-[17px] leading-[1.65]">
                  A living digital twin of how the firm actually runs. It
                  guides the change. It stays with the company after I leave.
                </p>
              </div>
            </article>
            ...
            <article className="build-row">
              ...
              <div className="build-copy">
                ...
                <p className="mt-1 font-vollkorn text-[16px] font-bold text-navy/70">
                  The 100% Agentic Workflow Building Machine
                </p>
                <p className="mt-3 text-[17px] leading-[1.65]">
                  Agentic end to end, through supervised, inspectable blocks. A
                  human makes the last consequential move. Proven in live
                  DigOps production.
                </p>
              </div>
            </article>
          ...
          <div className="mt-10 rounded-xl border border-[#142840]/15 bg-[#FBF9F4] p-6 text-center md:p-8">
            <h4 className="font-vollkorn text-[22px] font-extrabold text-navy">
              If you want the engine, let&apos;s talk.
            </h4>
            <div className="mt-5">
              <Link
                href="/contact/"
      ...
      <section className="p-section p-section--close">
        <div className="page-well">
          <h2 className="p-h2">If you want the engine, let&apos;s talk.</h2>
          <p className="mx-auto mt-4 max-w-[42ch] text-[18px] leading-[1.6]">
            I will tell you if it belongs, what it can change, and what has
            to stay in a person&apos;s hands.
          </p>
          <div className="mt-8">
