    ...
    <div className="font-body bg-cream text-navy">
      ...
      <section id="contact" className="relative overflow-hidden bg-cream">
        <div className="mx-auto max-w-[1440px] px-6 md:px-12 lg:px-24 py-28 md:py-36 pb-20">
          ...
          {/* Tri-column mark area */}
          <div className="mt-20 pt-10 border-t border-navy/15 grid grid-cols-1 md:grid-cols-3 gap-12 items-end">
            <div className="font-body text-warm-gray text-[13px] leading-[1.5]">
              <b className="block font-vollkorn text-navy text-[14px] font-bold tracking-[0.04em] mb-1.5">
                The Practice
              </b>
              idigdata — Data Integration Group, est. 2016. A boutique
              transformation residency for mid-market operating companies.
            </div>
            <div className="font-body text-warm-gray text-[13px] leading-[1.5]">
              <b className="block font-vollkorn text-navy text-[14px] font-bold tracking-[0.04em] mb-1.5">
                Engagement Tier
              </b>
              One operator. One company at a time. Mutual selection.
            </div>
            <div className="flex flex-col items-start gap-3.5">
              <b className="font-vollkorn text-navy text-[14px] font-bold tracking-[0.04em]">
                The Mark
              </b>
              <M4Lattice size={56} />
              <span className="font-vollkorn italic text-warm-gray text-[13px]">
                M4 — the lattice mark.
              </span>
            </div>
          </div>

          {/* BEGIN column (preserves Claude Design footer-BEGIN signal here) */}
          <div className="mt-16 pt-10 border-t border-navy/15 grid grid-cols-1 md:grid-cols-[1fr_auto] gap-8 items-end">
            <div>
              <p className="font-body text-[10px] uppercase tracking-[0.22em] font-bold text-gold mb-3">
                Begin
              </p>
              <ul className="font-body text-navy text-[14px] flex flex-col gap-2">
                <li>
                  <Link
                    href="/contact/"
            ...
            <p className="font-vollkorn italic text-warm-gray text-[12px] md:text-right">
              Set in Vollkorn. Composed deliberately, in Cream and Navy.
            </p>
          </div>
        </div>
      </section>
