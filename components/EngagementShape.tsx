...
export default function EngagementShape({
  name,
  lead,
  body,
  marker,
  ...
  if (variant === "editorial") {
    return (
      <div className="py-4 border-t border-stone">
        <h3 className="font-vollkorn font-bold text-navy text-[20px] leading-tight tracking-tight">
          {marker}
          {name}
        </h3>
        <p className="mt-2 font-display italic text-navy text-[16px] leading-snug">
          {lead}
        </p>
        <div className="mt-3 font-body text-ink text-[16px] leading-relaxed">
          {body}
        </div>
      </div>
    );
