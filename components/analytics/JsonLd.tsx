const organizationSchema = {
  ...
  description:
    "Independent practice for enterprise transformation and business systems, led by transformational CIO Robert Paddock — embedded at senior-operator altitude inside $100M–$1B operating companies across architecture-engineering-construction (AEC), beverage consumer packaged goods (CPG), and healthcare. Applied AI in production is the current edge. System breadth: ERP, WMS, MES, EMR, LIMS, QMS, CPQ, CRM, MDM, HRIS, with a Common Data Model and master-data discipline under every engagement. Business-owned substrate. Vendor-agnostic. Exit-by-design.",
  founder: {
    "@type": "Person",
    name: "Robert Paddock",
